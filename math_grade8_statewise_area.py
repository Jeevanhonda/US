...
def show():
    ...
    states_col1 = state_list[:len(state_list) // 2]  
    states_col2 = state_list[len(state_list) // 2:]  
    ...
    with col1:
        ...
        for state in states_col1:
            disabled = False if st.session_state.selected_state is None else st.session_state.selected_state != state
